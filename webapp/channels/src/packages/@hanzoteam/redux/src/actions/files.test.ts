...
import * as Actions from '@hanzoteam/redux/actions/files';
...
describe('Actions.Files', () => {
    ...
    it('getFilesForPost', async () => {
        ...
        const testImageData = fs.createReadStream(`src/packages/@hanzoteam/redux/test/assets/images/${testFileName}`);
