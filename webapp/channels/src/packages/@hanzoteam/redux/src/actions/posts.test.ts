...
import type {Post, PostList} from '@hanzoteam/types/posts';
...
import {createCustomEmoji} from '@hanzoteam/redux/actions/emojis';
import * as Actions from '@hanzoteam/redux/actions/posts';
import {loadMe} from '@hanzoteam/redux/actions/users';
import {Client4} from '@hanzoteam/redux/client';
import {isPostFlagged} from '@hanzoteam/redux/selectors/entities/posts';
import type {GetStateFunc} from '@hanzoteam/redux/types/actions';
...
describe('Actions.Posts', () => {
    ...
    it('getCustomEmojiForReaction', async () => {
        const testImageData = fs.createReadStream('src/packages/@hanzoteam/redux/test/assets/images/test.png');
        const {dispatch, getState} = store;
