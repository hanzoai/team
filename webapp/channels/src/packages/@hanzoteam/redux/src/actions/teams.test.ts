...
import type {Team, TeamsWithCount} from '@hanzoteam/types/teams';

import {UserTypes} from '@hanzoteam/redux/action_types';
import * as Actions from '@hanzoteam/redux/actions/teams';
...
describe('Actions.Teams', () => {
    ...
    it('setTeamIcon', async () => {
        ...
        const imageData = fs.createReadStream('src/packages/@hanzoteam/redux/test/assets/images/test.png');
