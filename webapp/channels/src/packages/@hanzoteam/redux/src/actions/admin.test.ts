...
import type {CreateDataRetentionCustomPolicy} from '@hanzoteam/types/data_retention';
import type {Team} from '@hanzoteam/types/teams';

import * as Actions from '@hanzoteam/redux/actions/admin';
...
describe('Actions.Admin', () => {
    ...
    it('uploadPublicSamlCertificate', async () => {
        const testFileData = fs.createReadStream('src/packages/@hanzoteam/redux/test/assets/images/test.png');
