...
import type {OrderedChannelCategories, ChannelCategory} from '@hanzoteam/types/channel_categories';
import {CategorySorting} from '@hanzoteam/types/channel_categories';
import type {Channel} from '@hanzoteam/types/channels';
import type {PropertyValuesUpdated} from '@hanzoteam/types/properties';
import type {Team} from '@hanzoteam/types/teams';

import {ChannelCategoryTypes, ChannelTypes, PropertyTypes} from '@hanzoteam/redux/action_types';
...
import {CategoryTypes, ManagedCategoryPropertyFieldName, ManagedCategoryPropertyGroupName} from '@hanzoteam/redux/constants/channel_categories';
import {
...
import {getPropertyFieldById, getPropertyGroupById, getPropertyGroupByName} from '@hanzoteam/redux/selectors/entities/properties';
import {getCurrentUserId} from '@hanzoteam/redux/selectors/entities/users';
import type {
    ActionFuncAsync,
    ThunkActionFunc,
} from '@hanzoteam/redux/types/actions';
import {insertMultipleWithoutDuplicates, insertWithoutDuplicates, removeItem} from '@hanzoteam/redux/utils/array_utils';
