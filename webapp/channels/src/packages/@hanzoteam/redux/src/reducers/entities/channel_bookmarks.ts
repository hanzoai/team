...
import type {ChannelBookmark, ChannelBookmarksState} from '@hanzoteam/types/channel_bookmarks';
...
import {ChannelBookmarkTypes, UserTypes, ChannelTypes} from '@hanzoteam/redux/action_types';
