...
* QFIX: · Fix separator and folder scroll in test management ([#7165](https://github.com/hanzoai/team-manager/issues/7165)) 
...
* 🐛 BUG FIXES: · Get rid of @html usages ([#7072](https://github.com/hanzoai/team-manager/issues/7072)) 
...
* QFIX: · Account migration ([#6787](https://github.com/hanzoai/team-manager/issues/6787)) 
...
* EZQMS-1069: · Fix request model ([#6131](https://github.com/hanzoai/team-manager/issues/6131)) · Fix request model ([#6131](https://github.com/hanzoai/team-manager/issues/6131)) 
...
* UBERF-7495: · Global editor kit extensions ([#6057](https://github.com/hanzoai/team-manager/issues/6057)) 
...
* UBERF-7428: · Fix memory issues ([#5940](https://github.com/hanzoai/team-manager/issues/5940)) 
...
* UBERF-7114: · Fix workspace from clone ([#5703](https://github.com/hanzoai/team-manager/issues/5703)) 
...
* UBERF-5348: · Fix new status creation ([#4567](https://github.com/hanzoai/team-manager/issues/4567)) 
...
* EZQMS-457: · Added optional ModeSelector to SpecialView ([#4381](https://github.com/hanzoai/team-manager/issues/4381)) 
...
* 🚀 FEATURES: · *(tests)* TESTS-54 done Edit a Milestone test ([#4175](https://github.com/hanzoai/team-manager/issues/4175)) · *(tests)* TESTS-55 done Delete a Milestone test ([#4184](https://github.com/hanzoai/team-manager/issues/4184)) · *(tests)* Updated tests ([#4185](https://github.com/hanzoai/team-manager/issues/4185)) · *(tests)* Updated sanity-ws dump and tests ([#4202](https://github.com/hanzoai/team-manager/issues/4202)) · *(tests)* TESTS-45 done Move to project test ([#4203](https://github.com/hanzoai/team-manager/issues/4203)) · *(tests)* Updated tests ([#4209](https://github.com/hanzoai/team-manager/issues/4209)) · *(tests)* Updated Edit a sub-issue test  ([#4210](https://github.com/hanzoai/team-manager/issues/4210)) · *(tests)* Updated move to project tests  ([#4214](https://github.com/hanzoai/team-manager/issues/4214)) · *(tests)* TESTS-81 done Comment stored test ([#4216](https://github.com/hanzoai/team-manager/issues/4216)) · *(tests)* Updated flaky tests ([#4218](https://github.com/hanzoai/team-manager/issues/4218)) · *(tests)* TESTS-106 ([#4217](https://github.com/hanzoai/team-manager/issues/4217)) · *(tests)* TESTS-41 done Delete a sub-issue test ([#4223](https://github.com/hanzoai/team-manager/issues/4223)) · *(tests)* Updated tests ([#4224](https://github.com/hanzoai/team-manager/issues/4224)) 
* EZQMS-440: · Fix quality events ([#4183](https://github.com/hanzoai/team-manager/issues/4183)) 
* TESTS-42: · Feat(tests): done Edit Sub-Issue test ([#4191](https://github.com/hanzoai/team-manager/issues/4191)) 
* TESTS-44: · Feat(tests): the Set parent issue test ([#4158](https://github.com/hanzoai/team-manager/issues/4158)) 
* TESTS-46: · Feat(tests): done New related issue test ([#4192](https://github.com/hanzoai/team-manager/issues/4192)) 
* TESTS-59: · Feat(tests): done Create an Issue from template test  ([#4212](https://github.com/hanzoai/team-manager/issues/4212)) 
* TESTS-98: · Feat(tests): done Created by filter test ([#4161](https://github.com/hanzoai/team-manager/issues/4161)) 
* TESTS-99: · Feat(tests): done Component filter test  ([#4162](https://github.com/hanzoai/team-manager/issues/4162)) 
* TSK-1668: · Survey plugin ([#4174](https://github.com/hanzoai/team-manager/issues/4174)) 
* UBER-1179: · Fix comments saving ([#4205](https://github.com/hanzoai/team-manager/issues/4205)) 
* UBER-1182: · Fix github task types support ([#4215](https://github.com/hanzoai/team-manager/issues/4215)) · Fix task type categories ([#4222](https://github.com/hanzoai/team-manager/issues/4222)) 
* UBERF-4248: · Task type ([#4042](https://github.com/hanzoai/team-manager/issues/4042)) 
* UBERF-4432: · Better notifications for Chunter ([#4165](https://github.com/hanzoai/team-manager/issues/4165)) 
* UBERF-4610: · Fix checkbox behaviour ([#4173](https://github.com/hanzoai/team-manager/issues/4173)) 
* UBERF-4620: · Fix show less triangle ([#4182](https://github.com/hanzoai/team-manager/issues/4182)) 
* UBERF-4632: · Refactor activity classes structure ([#4190](https://github.com/hanzoai/team-manager/issues/4190)) 
* UBERF-4649: · Fix query projection/cache issue ([#4200](https://github.com/hanzoai/team-manager/issues/4200)) 
...
* EZQMS-394: · Update diff viewer lint button colors ([#4115](https://github.com/hanzoai/team-manager/issues/4115)) 
* UBERF-4527: · Extra logging for client ([#4133](https://github.com/hanzoai/team-manager/issues/4133)) 
...
* 🚀 FEATURES: · *(tests)* Updated create-vacancy test ([#4091](https://github.com/hanzoai/team-manager/issues/4091)) 
* EZQMS-398: · Fix StringDiffViewer ([#4089](https://github.com/hanzoai/team-manager/issues/4089)) 
* TESTS-92: · Feat(tests): done Tracker filters tests - Modified date ([#4094](https://github.com/hanzoai/team-manager/issues/4094)) 
* UBERF-4238: · Fix calendar utils ([#4092](https://github.com/hanzoai/team-manager/issues/4092)) 
* UBERF-4428: · Add option to disable indexing for a class ([#4090](https://github.com/hanzoai/team-manager/issues/4090)) 
* UBERF-4446: · Move search from text editor ([#4093](https://github.com/hanzoai/team-manager/issues/4093)) 

## [0.6.161] - 2023-11-28

* EZQMS-398: · Update CollaborationDiffViewer ([#4075](https://github.com/hanzoai/team-manager/issues/4075)) · Add StringDiffViewer ([#4085](https://github.com/hanzoai/team-manager/issues/4085)) 
* QFIX: · Fix asterisk usage in forms ([#4080](https://github.com/hanzoai/team-manager/issues/4080)) 
* TESTS-56: · Feat(tests): done Create a Template test ([#4063](https://github.com/hanzoai/team-manager/issues/4063)) 
* TESTS-57: · Feat(tests): done Edit a Template test ([#4079](https://github.com/hanzoai/team-manager/issues/4079)) 
* TESTS-88: · Feat(tests): done Add comment from several users test ([#4054](https://github.com/hanzoai/team-manager/issues/4054)) 
* UBERF-4165: · Add search to actions popup ([#4057](https://github.com/hanzoai/team-manager/issues/4057)) 
* UBERF-4413: · Kanban with huge data sets ([#4076](https://github.com/hanzoai/team-manager/issues/4076)) 
* UBERF-4420: · Bump fieldStateId ([#4071](https://github.com/hanzoai/team-manager/issues/4071)) 
...
* UBER-945: · Pinning for comments ([#4050](https://github.com/hanzoai/team-manager/issues/4050)) 
* UBERF-4384: · Update space from attributes ([#4049](https://github.com/hanzoai/team-manager/issues/4049)) 
* UBERF-4388: · Few performance related fixes ([#4053](https://github.com/hanzoai/team-manager/issues/4053)) 

## [0.6.158] - 2023-11-23

* EZQMS-368: · Fix exit text editor node uuid extension node ([#4044](https://github.com/hanzoai/team-manager/issues/4044)) 
* TESTS-85: · Feat(tests): added issues.spec.ts test ([#4025](https://github.com/hanzoai/team-manager/issues/4025)) 
* TESTS-87: · Feat(tests): done Issues status can be changed by another users test ([#4036](https://github.com/hanzoai/team-manager/issues/4036)) 
* UBER-1167: · Revert All/Active/Backlog for issues ([#4047](https://github.com/hanzoai/team-manager/issues/4047)) 
* UBER-636: · Fix from&to for NewMessage ([#4043](https://github.com/hanzoai/team-manager/issues/4043)) 
* UBERF-4302: · Added footer to Calendar ([#4033](https://github.com/hanzoai/team-manager/issues/4033)) 
* UBERF-4325: · Boost titles ([#4023](https://github.com/hanzoai/team-manager/issues/4023)) 

## [0.6.157] - 2023-11-21

* EZQMS-342: · Add text editor configurable active highlighted node  ([#4019](https://github.com/hanzoai/team-manager/issues/4019)) 
* TESTS-71: · Feat(tests): updated allure parent suite ([#4010](https://github.com/hanzoai/team-manager/issues/4010)) 
* UBER-1074: · Svelte 4 ([#4014](https://github.com/hanzoai/team-manager/issues/4014)) 
* UBER-911: · Mentions without second input and tabs ([#3798](https://github.com/hanzoai/team-manager/issues/3798)) 
* UBERF-4229: · Fix createAttachments runtime error ([#3960](https://github.com/hanzoai/team-manager/issues/3960)) 
* UBERF-4324: · While indexing is still in progress we see undefined ([#4017](https://github.com/hanzoai/team-manager/issues/4017)) 
* UBERF-4348: · Mentions. Fix render props types and component props types ([#4022](https://github.com/hanzoai/team-manager/issues/4022)) 
...
* 🚀 FEATURES: · *(tests)* Added allure report for tests ([#3944](https://github.com/hanzoai/team-manager/issues/3944)) 
* UBERF-4161: · Few inbox fixes ([#3976](https://github.com/hanzoai/team-manager/issues/3976)) 
* UBERF-4205: · Updated Panel header layout, custom aside ([#3974](https://github.com/hanzoai/team-manager/issues/3974)) 
* UBERF-4263: · Restore Back and Close button, fixed selectedAside ([#3983](https://github.com/hanzoai/team-manager/issues/3983)) 
...
* UBER-1127: · Updated status bar layout ([#3940](https://github.com/hanzoai/team-manager/issues/3940)) 
* UBER-1141: · Fixed Comments popup layout ([#3946](https://github.com/hanzoai/team-manager/issues/3946)) 
* UBER-1159: · Fixed horizontal scrolling in Scroller ([#3945](https://github.com/hanzoai/team-manager/issues/3945)) 
* UBER-1161: · Remove async to correctly handle query change ([#3951](https://github.com/hanzoai/team-manager/issues/3951)) 
* UBER-942: · Rework skill optimization ([#3941](https://github.com/hanzoai/team-manager/issues/3941)) 

## [0.6.151] - 2023-11-03

* EZQMS-350: · Fix reactions in threads ([#3935](https://github.com/hanzoai/team-manager/issues/3935)) 
* UBER-1143: · Additional skill parsing, increase timeout for filter ([#3933](https://github.com/hanzoai/team-manager/issues/3933)) 
* UBER-1157: · Some dependant fixes ([#3936](https://github.com/hanzoai/team-manager/issues/3936)) 
...
* 🚀 FEATURES: · *(tests)* TESTS-43 added the Create an issue with all params test ([#3905](https://github.com/hanzoai/team-manager/issues/3905)) 
* 🐛 BUG FIXES: · *(tests)* Updated the today selector for calendar ([#3908](https://github.com/hanzoai/team-manager/issues/3908)) · *(tests)* Updated the today selector for issues page ([#3911](https://github.com/hanzoai/team-manager/issues/3911)) 
* EZQMS-327: · Move inline comments to platform popups ([#3909](https://github.com/hanzoai/team-manager/issues/3909)) 
* EZQMS-333: · Customizable RadioButton label ([#3900](https://github.com/hanzoai/team-manager/issues/3900)) 
* TESTS-18: · Feat(tests): added edit vacancy test ([#3901](https://github.com/hanzoai/team-manager/issues/3901)) 
* UBER-1101: · Updated Separator (Float mode), fixed Scroller visibility ([#3902](https://github.com/hanzoai/team-manager/issues/3902)) 
* UBER-1146: · Fix scrolling in emojis popup ([#3912](https://github.com/hanzoai/team-manager/issues/3912)) 

## [0.6.148] - 2023-10-26

* UBER-1027: · Don't update issue space in kanban view ([#3895](https://github.com/hanzoai/team-manager/issues/3895)) 
* UBER-634: · Focus on SelectPopup ([#3897](https://github.com/hanzoai/team-manager/issues/3897)) 
* UBER-898: · Assignee rules and general rules fix ([#3894](https://github.com/hanzoai/team-manager/issues/3894)) 

## [0.6.147] - 2023-10-26

* 🚀 FEATURES: · *(tests)* Added Change & Save all States test ([#3863](https://github.com/hanzoai/team-manager/issues/3863)) · *(tests)* TESTS-10 added the Delete the Talent test ([#3883](https://github.com/hanzoai/team-manager/issues/3883)) 
* EZQMS-306: · Add extensions for chunter message version ([#3882](https://github.com/hanzoai/team-manager/issues/3882)) 
* TESTS-22: · Feat(tests): done test Merge Contacts  ([#3891](https://github.com/hanzoai/team-manager/issues/3891)) 
* TESTS-9: · Feat(tests): added edit Talent test ([#3871](https://github.com/hanzoai/team-manager/issues/3871)) 
* UBER-1088: · ListItem fix. ([#3872](https://github.com/hanzoai/team-manager/issues/3872)) 
* UBER-1097: · Remove second status editor amd fix done state selection in new Applicant popup ([#3869](https://github.com/hanzoai/team-manager/issues/3869)) 
* UBER-1099,-1100: · Milestone fixes. ([#3873](https://github.com/hanzoai/team-manager/issues/3873)) 
* UBER-1106,-1108: · Update navigator and button layout ([#3870](https://github.com/hanzoai/team-manager/issues/3870)) 
* UBER-1128: · Fix to many requests from query ([#3888](https://github.com/hanzoai/team-manager/issues/3888)) 
* UBER-1129: · Fix list support attached documents properly ([#3889](https://github.com/hanzoai/team-manager/issues/3889)) 
* UBER-937: · Extensibility changes ([#3874](https://github.com/hanzoai/team-manager/issues/3874)) 
* UBER-942: · Fix-skills script ([#3876](https://github.com/hanzoai/team-manager/issues/3876)) 
* EZQMS-331: · Fix disabled button icon style ([#3881](https://github.com/hanzoai/team-manager/issues/3881)) 

## [0.6.146] - 2023-10-23

* 🚀 FEATURES: · *(tests)* Added delete application test ([#3859](https://github.com/hanzoai/team-manager/issues/3859)) 
...
* UBER-1039: · Codeblock style fixes. ([#3829](https://github.com/hanzoai/team-manager/issues/3829)) 
* UBERF-3997: · Fix Tab navigation in text editors ([#3832](https://github.com/hanzoai/team-manager/issues/3832)) 

## [0.6.141] - 2023-10-11

* UBER-1038: · Fix flicking during issue creation ([#3826](https://github.com/hanzoai/team-manager/issues/3826)) 
* UBER-953: · Fix related issues ([#3821](https://github.com/hanzoai/team-manager/issues/3821)) 
...
* UBER-955: · Added Separator component ([#3804](https://github.com/hanzoai/team-manager/issues/3804)) 

## [0.6.138] - 2023-10-06

* QFIX: · Child info could be empty ([#3785](https://github.com/hanzoai/team-manager/issues/3785)) 
* UBER-987: · Fix emojis in the middle of something (URLs) ([#3790](https://github.com/hanzoai/team-manager/issues/3790)) 

## [0.6.137] - 2023-10-03

* EZQMS-279: · Remove .ProseMirror global css ([#3772](https://github.com/hanzoai/team-manager/issues/3772)) 
* UBER-974: · Fix saved views and mode in filters ([#3780](https://github.com/hanzoai/team-manager/issues/3780)) 
* UBER-977: · A remaining time ([#3783](https://github.com/hanzoai/team-manager/issues/3783)) 

## [0.6.136] - 2023-10-02

* UBER-963: · Related issues ([#3773](https://github.com/hanzoai/team-manager/issues/3773)) 
* UBERF-17: · Missing smiles auto-conversion in rich texts :) ([#3771](https://github.com/hanzoai/team-manager/issues/3771)) 
...
* CALENDAR: · Resize and move event ([#3750](https://github.com/hanzoai/team-manager/issues/3750)) 
* UBER-845: · Add NotificationPresenter to send rich text notifications ([#3729](https://github.com/hanzoai/team-manager/issues/3729)) 
* UBER-924: · Fix file upload progress ([#3757](https://github.com/hanzoai/team-manager/issues/3757)) 
...
* QFIX: · Migration ([#3734](https://github.com/hanzoai/team-manager/issues/3734)) 
* UBER-888: · Fixed dragging of the WorkItem ([#3735](https://github.com/hanzoai/team-manager/issues/3735)) 

## [0.6.131] - 2023-09-22

* UBER-486: · Updated people avatars. ([#3720](https://github.com/hanzoai/team-manager/issues/3720)) · Replaced avatar colors ([#3724](https://github.com/hanzoai/team-manager/issues/3724)) 
* UBER-799: · Allow extensions to tracker for github ([#3727](https://github.com/hanzoai/team-manager/issues/3727)) 
* UBER-888: · Fixed dragging of the WorkItem ([#3730](https://github.com/hanzoai/team-manager/issues/3730)) 

## [0.6.130] - 2023-09-20

* UBER-881: · Fix labels list view numbers ([#3721](https://github.com/hanzoai/team-manager/issues/3721)) 

## [0.6.129] - 2023-09-20

* UBER-885: · Value filter fix ([#3719](https://github.com/hanzoai/team-manager/issues/3719)) 
...
* UBER-784: · Updated WorkItemPresenter ([#3710](https://github.com/hanzoai/team-manager/issues/3710)) 
* UBER-796: · Fixed AttachmentActions ([#3709](https://github.com/hanzoai/team-manager/issues/3709)) 
* UBER-834: · Improve list speed ([#3692](https://github.com/hanzoai/team-manager/issues/3692)) 
* UBER-839: · Request the category if it's not in lookup ([#3679](https://github.com/hanzoai/team-manager/issues/3679)) 
* UBER-841: · Allowed to position work item to half hour ([#3707](https://github.com/hanzoai/team-manager/issues/3707)) 
* UBER-851: · Fix titles in ListView ([#3678](https://github.com/hanzoai/team-manager/issues/3678)) 
* UBER-852: · Owner should only see a list of spaces ([#3677](https://github.com/hanzoai/team-manager/issues/3677)) 
* UBER-854: · More proper upgrade notification ([#3694](https://github.com/hanzoai/team-manager/issues/3694)) 
* UBER-863: · Fix employee filter ([#3682](https://github.com/hanzoai/team-manager/issues/3682)) 
* UBER-869: · Fixed mentions in Activity. Fixed messages in Inbox. ([#3695](https://github.com/hanzoai/team-manager/issues/3695)) 
* UBER-871: · Allow to hide/show archived and done in vacancies list ([#3701](https://github.com/hanzoai/team-manager/issues/3701)) 
* UBER-872: · StyleTextEditor: No update when change text in another text ([#3698](https://github.com/hanzoai/team-manager/issues/3698)) 
* UBERF-81: · Replacing the label ([#3708](https://github.com/hanzoai/team-manager/issues/3708)) 
...
* 🐛 BUG FIXES: · Trim cookie string before extracting values ([#3652](https://github.com/hanzoai/team-manager/issues/3652)) 
* ACTIVITY: · Remove inline from presenters. DoneStatesPopup fix. ([#3664](https://github.com/hanzoai/team-manager/issues/3664)) 
* UBER-564: · Add sound notification and settings ([#3655](https://github.com/hanzoai/team-manager/issues/3655)) 
* UBER-674: · The calendar starts from the current time. Calendar fixes. ([#3671](https://github.com/hanzoai/team-manager/issues/3671)) 
* UBER-795: · Updated layout of pop-ups. There is always a Back in the Panel. ([#3644](https://github.com/hanzoai/team-manager/issues/3644)) · Replacing the Panel with a Dialog, fix circle button in Kanban. ([#3659](https://github.com/hanzoai/team-manager/issues/3659)) 
* UBER-807: · Multiple github repositories fixes ([#3646](https://github.com/hanzoai/team-manager/issues/3646)) · Allow to customize create issue dialog ([#3669](https://github.com/hanzoai/team-manager/issues/3669)) 
* UBER-832: · Fixed DatePresenter ([#3653](https://github.com/hanzoai/team-manager/issues/3653)) 
* UBER-838: · Signout button for inactive accounts ([#3662](https://github.com/hanzoai/team-manager/issues/3662)) 
* UBERF-55: · Change editor toolbar behavior and update icons ([#3645](https://github.com/hanzoai/team-manager/issues/3645)) 
* UBERF-60: · Update styles and presenters. ([#3651](https://github.com/hanzoai/team-manager/issues/3651)) · Updated Rich editor and Activity styles. ([#3661](https://github.com/hanzoai/team-manager/issues/3661)) · Updated inline presenters. ([#3663](https://github.com/hanzoai/team-manager/issues/3663)) 
...
* UBER-773: · Fix List search anv Vacancy view ([#3614](https://github.com/hanzoai/team-manager/issues/3614)) 
...
* TEAM: · Planning UI fixes ([#3599](https://github.com/hanzoai/team-manager/issues/3599)) 
* UBER-479: · Add List view for Vacancies ([#3595](https://github.com/hanzoai/team-manager/issues/3595)) 
* UBER-500: · Confusing Show More button in table ([#3590](https://github.com/hanzoai/team-manager/issues/3590)) 
* UBER-743: · Provide person instead of id as prop ([#3592](https://github.com/hanzoai/team-manager/issues/3592)) 
* UBER-747: · Fix readonly field ([#3593](https://github.com/hanzoai/team-manager/issues/3593)) 
* UBER-759: · Prevent mutations of original object ([#3596](https://github.com/hanzoai/team-manager/issues/3596)) 

## [0.6.117] - 2023-08-14

* EZQMS-236: · QE templates >> Have the ability to make a section mandatory ([#3581](https://github.com/hanzoai/team-manager/issues/3581)) 

## [0.6.116] - 2023-08-10

* EZQMS-152: · Some object selector dropdown items are cut ([#3558](https://github.com/hanzoai/team-manager/issues/3558)) 
* FIX: · Grammatical and stylistic errors ([#3552](https://github.com/hanzoai/team-manager/issues/3552)) 
* UBER-720: · Rework list view to multiple requests ([#3578](https://github.com/hanzoai/team-manager/issues/3578)) 
* EZQMS-245: · Allow configurable languages per deployments ([#3579](https://github.com/hanzoai/team-manager/issues/3579)) 
...
* UBER-619: · StatusPopup for creating/renaming ([#3536](https://github.com/hanzoai/team-manager/issues/3536)) 
* UBER-665: · Rename EmployeeAccount->PersonAccount ([#3550](https://github.com/hanzoai/team-manager/issues/3550)) 
...
* UBER-646: · Clear the class when view is changed to prevent using old one ([#3541](https://github.com/hanzoai/team-manager/issues/3541)) 
* EZQMS-241: · Account for parent classes configurations in list view ([#3537](https://github.com/hanzoai/team-manager/issues/3537)) 
...
* 🐛 BUG FIXES: · Do not shrink expand/collapse icon in tree ([#3517](https://github.com/hanzoai/team-manager/issues/3517)) 
* ATS-13: · Support multiple docs for copying ([#3526](https://github.com/hanzoai/team-manager/issues/3526)) · Copy ID action ([#3533](https://github.com/hanzoai/team-manager/issues/3533)) 
* CALENDAR: · Fixed the display of the past days (events) ([#3527](https://github.com/hanzoai/team-manager/issues/3527)) 
* QFIX: · Translate ezqms email confirmation letter to english ([#3532](https://github.com/hanzoai/team-manager/issues/3532)) 
* TSK-1574: · Accurate time reports count ([#3509](https://github.com/hanzoai/team-manager/issues/3509)) 
* UBER-427: · Disable third-nested filters ([#3502](https://github.com/hanzoai/team-manager/issues/3502)) 
* UBER-550: · Clean milestone when moving to another project ([#3498](https://github.com/hanzoai/team-manager/issues/3498)) 
* UBER-558: · Filter out overrides for action popup ([#3499](https://github.com/hanzoai/team-manager/issues/3499)) 
* UBER-575: · Allow per class list view ([#3524](https://github.com/hanzoai/team-manager/issues/3524)) 
* UBER-593: · Hyperlink editor ([#3506](https://github.com/hanzoai/team-manager/issues/3506)) 
* UBER-601: · Fixed accentuation of ObjectPresenter ([#3507](https://github.com/hanzoai/team-manager/issues/3507)) 
* UBER-609: · Fix inbox notification/view for telegram and gmail messages ([#3518](https://github.com/hanzoai/team-manager/issues/3518)) 
* UBER-614: · Fix submenu popups on scrolling ([#3530](https://github.com/hanzoai/team-manager/issues/3530)) 
* UBER-621: · Display field validation rule hint ([#3521](https://github.com/hanzoai/team-manager/issues/3521)) 
* UBER-642: · Use system theme as the default value for application theme ([#3534](https://github.com/hanzoai/team-manager/issues/3534)) 

## [0.6.111] - 2023-07-13

* ATS-9: · Update states once template updates ([#3496](https://github.com/hanzoai/team-manager/issues/3496)) 
* TSK-336: · Mobile UI adaptation ([#3492](https://github.com/hanzoai/team-manager/issues/3492)) 
* UBER-524: · Cleaned CSS, UI fixes. ([#3491](https://github.com/hanzoai/team-manager/issues/3491)) 

## [0.6.110] - 2023-07-08

* UBER-142: · Update buttons. Cleaning CSS. ([#3482](https://github.com/hanzoai/team-manager/issues/3482)) 
* UBER-298: · Add readonly users option to the UserBoxItems component ([#3481](https://github.com/hanzoai/team-manager/issues/3481)) 
* UBER-413: · Allow extensible navigator model ([#3477](https://github.com/hanzoai/team-manager/issues/3477)) 
* UBER-428: · Displaying tooltips with a delay ([#3442](https://github.com/hanzoai/team-manager/issues/3442)) 
* UBER-462: · Prevent creating existing enum value and disable the button in that case ([#3465](https://github.com/hanzoai/team-manager/issues/3465)) 
* UBER-472: · Don't update when it's not needed ([#3460](https://github.com/hanzoai/team-manager/issues/3460)) 
* UBER-473: · Show icon for department ([#3472](https://github.com/hanzoai/team-manager/issues/3472)) 
* UBER-477: · Uberflow dependencies ([#3440](https://github.com/hanzoai/team-manager/issues/3440)) 
* UBER-498: · Replace component shortcut ([#3441](https://github.com/hanzoai/team-manager/issues/3441)) 
* UBER-504: · Correct display of optional presenters ([#3452](https://github.com/hanzoai/team-manager/issues/3452)) · Fix presenters on ListItem. Add DeviceSizes. ([#3463](https://github.com/hanzoai/team-manager/issues/3463)) 
* UBER-505: · Fix resolve errors in console ([#3449](https://github.com/hanzoai/team-manager/issues/3449)) 
* UBER-509: · Do not update list of unread right after reading ([#3461](https://github.com/hanzoai/team-manager/issues/3461)) 
* UBER-513: · Fix desktop app navigation ([#3459](https://github.com/hanzoai/team-manager/issues/3459)) 
* UBER-520: · Fix images drag & drop ([#3453](https://github.com/hanzoai/team-manager/issues/3453)) 
* UBER-525: · Fixed popup logic placement for top ([#3448](https://github.com/hanzoai/team-manager/issues/3448)) 
* UBER-528: · Fix desktop navigation ([#3450](https://github.com/hanzoai/team-manager/issues/3450)) 
* UBER-536: · Fix test stability ([#3466](https://github.com/hanzoai/team-manager/issues/3466)) 
* UBER-537: · Review support in inbox ([#3471](https://github.com/hanzoai/team-manager/issues/3471)) 
* UBER-538: · Update ListView layout. Subissues, related issues. ([#3467](https://github.com/hanzoai/team-manager/issues/3467)) · Fixed ListView and KanbanView. ([#3475](https://github.com/hanzoai/team-manager/issues/3475)) 
* UBER-554: · Show messages with error and allow resending ([#3488](https://github.com/hanzoai/team-manager/issues/3488)) 
* UBER-560: · Filter out current transaction and get mixin ([#3480](https://github.com/hanzoai/team-manager/issues/3480)) 
* UBER-572: · Fixed overflow for emoji. ([#3485](https://github.com/hanzoai/team-manager/issues/3485)) 
* UBER-573,-574: · Updated button styles, fixed ListView ([#3484](https://github.com/hanzoai/team-manager/issues/3484)) 

## [0.6.109] - 2023-06-16

* UBER-424: · Description not saving fix ([#3434](https://github.com/hanzoai/team-manager/issues/3434)) 
* UBER-450: · Update MentionList. ([#3431](https://github.com/hanzoai/team-manager/issues/3431)) 
* UBER-480: · Fix ValueFilter for space-like objects ([#3428](https://github.com/hanzoai/team-manager/issues/3428)) 
* UBER-482: · Fix 'backspace' in inbox for some objects ([#3437](https://github.com/hanzoai/team-manager/issues/3437)) 
* UBER-485: · Implement icons. ([#3433](https://github.com/hanzoai/team-manager/issues/3433)) 
* UBER-488: · Update selected priority on issue switch ([#3436](https://github.com/hanzoai/team-manager/issues/3436)) 
* UBER-496: · Fix few issues ([#3439](https://github.com/hanzoai/team-manager/issues/3439)) 
...
* UBER-458: · Fix submenu ([#3416](https://github.com/hanzoai/team-manager/issues/3416)) 
* UBER-459: · Remove whereSelected line in dropdowns. ([#3417](https://github.com/hanzoai/team-manager/issues/3417)) 
* UBER-460: · Fix admin view ([#3420](https://github.com/hanzoai/team-manager/issues/3420)) 

## [0.6.106] - 2023-06-08

* UBER-158: · New popup dialog ([#3409](https://github.com/hanzoai/team-manager/issues/3409)) 
* UBER-425: · Tooltup/popup fixes ([#3404](https://github.com/hanzoai/team-manager/issues/3404)) 
* UBER-433: · Allow tabs within bullets. ([#3399](https://github.com/hanzoai/team-manager/issues/3399)) 
* UBER-438: · Use tracker as default for new users/workspaces ([#3403](https://github.com/hanzoai/team-manager/issues/3403)) 
* UBER-439: · Fix plurals in russian ([#3412](https://github.com/hanzoai/team-manager/issues/3412)) 
* UBER-440: · Fix link error message ([#3406](https://github.com/hanzoai/team-manager/issues/3406)) 
* UBER-441,-443: · Disable fade in Scroller, change color for link and bg for Diff ([#3405](https://github.com/hanzoai/team-manager/issues/3405)) 
* UBER-442,-452: · Fixed login/signup layout, link, mention and backtick. ([#3408](https://github.com/hanzoai/team-manager/issues/3408)) 
* UBER-453: · Update favicons. ([#3414](https://github.com/hanzoai/team-manager/issues/3414)) 
...
* UBER-395: · Allow to drop images into description ([#3382](https://github.com/hanzoai/team-manager/issues/3382)) 
* UBER-418: · Fix object popup a bit ([#3377](https://github.com/hanzoai/team-manager/issues/3377)) 

## [0.6.102] - 2023-06-06

* UBER-252: · Mode int URL in MyLeads/MyApplications ([#3347](https://github.com/hanzoai/team-manager/issues/3347)) 
* UBER-371: · Retina images for login page ([#3351](https://github.com/hanzoai/team-manager/issues/3351)) 
* UBER-373: · Fix blurry avatars and other images ([#3353](https://github.com/hanzoai/team-manager/issues/3353)) 
* UBER-377: · Fix login ([#3358](https://github.com/hanzoai/team-manager/issues/3358)) 
* UBER-380: · Change icon ([#3364](https://github.com/hanzoai/team-manager/issues/3364)) 
* UBER-383: · Fix null/undefined for URI and numbers ([#3359](https://github.com/hanzoai/team-manager/issues/3359)) 
* UBER-394: · Update tiptap plugins ([#3368](https://github.com/hanzoai/team-manager/issues/3368)) 
* UBER-397: · Fix panel activity ([#3370](https://github.com/hanzoai/team-manager/issues/3370)) 

## [0.6.101] - 2023-06-05

* UBER-263: · Use person after creation ([#3304](https://github.com/hanzoai/team-manager/issues/3304)) 
* UBER-276: · New messages and Has messages option for filter ([#3326](https://github.com/hanzoai/team-manager/issues/3326)) 
* UBER-318: · Allow to configure default language ([#3342](https://github.com/hanzoai/team-manager/issues/3342)) 
* UBER-358: · Fix icons ([#3338](https://github.com/hanzoai/team-manager/issues/3338)) 
* UBER-364: · Adapt updated UI ([#3348](https://github.com/hanzoai/team-manager/issues/3348)) 
* UBER-369: · Do not show number of comments if 0 ([#3349](https://github.com/hanzoai/team-manager/issues/3349)) 

## [0.6.100] - 2023-06-02

* UBER-137: · Fix application search ([#3309](https://github.com/hanzoai/team-manager/issues/3309)) 
* UBER-170: · Navigation for contacts ([#3323](https://github.com/hanzoai/team-manager/issues/3323)) 
* UBER-172: · Fill contact template fields if only one selected ([#3299](https://github.com/hanzoai/team-manager/issues/3299)) 
* UBER-304: · Fixed Navigator ([#3312](https://github.com/hanzoai/team-manager/issues/3312)) 
* UBER-307,-308,-310,-311,-312: · Fixed activity in Inbox ([#3298](https://github.com/hanzoai/team-manager/issues/3298)) 
* UBER-327: · Sub issues/Related issues allow to create from category header ([#3317](https://github.com/hanzoai/team-manager/issues/3317)) 
* UBER-328: · Fixed display in labels. Updated SelectWorkspaceMenu, AccountPopup. ([#3314](https://github.com/hanzoai/team-manager/issues/3314)) 
* UBER-331: · Fix live query update ([#3305](https://github.com/hanzoai/team-manager/issues/3305)) 
* UBER-338: · Added AppSwitcher popup. ([#3329](https://github.com/hanzoai/team-manager/issues/3329)) 
* UBER-345: · Fixed Inbox. ([#3325](https://github.com/hanzoai/team-manager/issues/3325)) 

## [0.6.99] - 2023-05-30

* UBER-199,-217,-232: · Fixed header in ListView, EditMember, ViewOptions ([#3273](https://github.com/hanzoai/team-manager/issues/3273)) 
* UBER-267: · Fix created selection ([#3269](https://github.com/hanzoai/team-manager/issues/3269)) 
* UBER-270: · Enable color more wide ([#3279](https://github.com/hanzoai/team-manager/issues/3279)) 
* UBER-271: · Fix filters ([#3293](https://github.com/hanzoai/team-manager/issues/3293)) 
* UBER-274,-287,-288,-294: · Fixed tooltip, ActionsPopup, ListHeader, activity. ([#3282](https://github.com/hanzoai/team-manager/issues/3282)) 
* UBER-278: · Add Yes-No to popup, refactor ([#3289](https://github.com/hanzoai/team-manager/issues/3289)) 
* UBER-279: · Total qfix ([#3281](https://github.com/hanzoai/team-manager/issues/3281)) 
* UBER-289: · Prevent empty changes to go into transactions. ([#3277](https://github.com/hanzoai/team-manager/issues/3277)) 
* UBER-295: · Fix blur'y popups ([#3278](https://github.com/hanzoai/team-manager/issues/3278)) 
* UBER-296: · Fix create application color selector ([#3280](https://github.com/hanzoai/team-manager/issues/3280)) 
* UBER-317: · Fix issue ([#3285](https://github.com/hanzoai/team-manager/issues/3285)) 
* UBER-319: · Fix vacancy editing ([#3290](https://github.com/hanzoai/team-manager/issues/3290)) 
* UBER-320: · Fix companies filter ([#3292](https://github.com/hanzoai/team-manager/issues/3292)) 

## [0.6.98a] - 2023-05-28

* UBER-268: · List views ([#3270](https://github.com/hanzoai/team-manager/issues/3270)) 
* UBER-269: · Fix mini toggle ([#3271](https://github.com/hanzoai/team-manager/issues/3271)) 

## [0.6.98] - 2023-05-27

* UBER-187: · Inline attachments ([#3264](https://github.com/hanzoai/team-manager/issues/3264)) 
* UBER-218: · Fix createOn -> createdOn ([#3266](https://github.com/hanzoai/team-manager/issues/3266)) 
* UBER-238: · Colors should not use alpha channel ([#3255](https://github.com/hanzoai/team-manager/issues/3255)) 
* UBER-265: · Updated application icons ([#3263](https://github.com/hanzoai/team-manager/issues/3263)) 
* UBER-266: · Fix mongo exceptions ([#3267](https://github.com/hanzoai/team-manager/issues/3267)) 
* UBER-267: · Fix Users popup ([#3268](https://github.com/hanzoai/team-manager/issues/3268)) 
* UBER-53: · My Leads view ([#3259](https://github.com/hanzoai/team-manager/issues/3259)) 
* UBER-64,-231,-229: · Updated CreateProject and SelectAvatar layouts, fixed bugs ([#3253](https://github.com/hanzoai/team-manager/issues/3253)) 

## [0.6.97] - 2023-05-24

* TSK-1523: · Fixed IssuePreview ([#3231](https://github.com/hanzoai/team-manager/issues/3231)) 
* TSK-1525: · Fixed VacancyPresenter ([#3237](https://github.com/hanzoai/team-manager/issues/3237)) 
* UBER-134: · Back references ([#3233](https://github.com/hanzoai/team-manager/issues/3233)) 
* UBER-135/TSK-1430: · Allow changing image in PDFViewer through arrow-keys (keyboard) ([#3186](https://github.com/hanzoai/team-manager/issues/3186)) 
* UBER-148: · My Applications in recruit ([#3235](https://github.com/hanzoai/team-manager/issues/3235)) 
* UBER-159: · Popup dialog for deleting with message if not enough permissions ([#3224](https://github.com/hanzoai/team-manager/issues/3224)) 
* UBER-182: · Fix status object filter ([#3250](https://github.com/hanzoai/team-manager/issues/3250)) 
* UBER-194,-166,-185: · Add application icons, fixed Inbox list and mobile layout ([#3229](https://github.com/hanzoai/team-manager/issues/3229)) 
* UBER-205: · More info to Kanban card (due date, assignee, Lead number) ([#3251](https://github.com/hanzoai/team-manager/issues/3251)) 
* UBER-206: · Redefined color palettes ([#3243](https://github.com/hanzoai/team-manager/issues/3243)) 
* UBER-219: · Updated CreateIssue layout ([#3244](https://github.com/hanzoai/team-manager/issues/3244)) 
* UBER-47: · Attributes for base class (ex. contacts in lead's customers) ([#3241](https://github.com/hanzoai/team-manager/issues/3241)) 
* UBER-49: · Custom fields in CreateLead ([#3249](https://github.com/hanzoai/team-manager/issues/3249)) 
* UBER-50: · Remove funnel browser ([#3236](https://github.com/hanzoai/team-manager/issues/3236)) 

## [0.6.96] - 2023-05-21

* TSK-1257: · Split owner name to first and last name fields ([#3156](https://github.com/hanzoai/team-manager/issues/3156)) 
* TSK-1402: · Fix default assignee when creating issues ([#3159](https://github.com/hanzoai/team-manager/issues/3159)) 
* TSK-1469,-1470: · Added SelectAvatars, UserBoxItems components ([#3176](https://github.com/hanzoai/team-manager/issues/3176)) 
* TSK-1489: · Fixed Components, Milestones, IssueTemplates layout ([#3220](https://github.com/hanzoai/team-manager/issues/3220)) 
* TSK-1500: · Enable compression by default ([#3177](https://github.com/hanzoai/team-manager/issues/3177)) 
* TSK-760: · Fix scroll issue for mac ([#3173](https://github.com/hanzoai/team-manager/issues/3173)) 
* UBER-122: · Fix invalid time report shown ([#3191](https://github.com/hanzoai/team-manager/issues/3191)) 
* UBER-130: · Fix expand/collapse on multiple levels ([#3198](https://github.com/hanzoai/team-manager/issues/3198)) 
* UBER-136: · Fix Exception with custom attributes ([#3195](https://github.com/hanzoai/team-manager/issues/3195)) 
* UBER-144: · Fixed showHeader ([#3214](https://github.com/hanzoai/team-manager/issues/3214)) 
* UBER-174: · Introduce createOn every there ([#3222](https://github.com/hanzoai/team-manager/issues/3222)) 
* UBER-177: · Fixed Filter pop-ups ([#3225](https://github.com/hanzoai/team-manager/issues/3225)) 
* UBER-48: · Custom fields for organization in leads ([#3203](https://github.com/hanzoai/team-manager/issues/3203)) 
* UBER-54: · Attempt to Expand/collapse issue fix ([#3183](https://github.com/hanzoai/team-manager/issues/3183)) 
* UBER-56: · Check if title is hidden for Candidate (Talent) in Kanban and Application. Fix Talent card width in Application ([#3196](https://github.com/hanzoai/team-manager/issues/3196)) 
* UBER-62: · Maintenance warnings ([#3210](https://github.com/hanzoai/team-manager/issues/3210)) 
* UBER-76: · Trigger search after timeout ([#3193](https://github.com/hanzoai/team-manager/issues/3193)) 
* UBER-81: · Fix move project ([#3182](https://github.com/hanzoai/team-manager/issues/3182)) 
* UBER-83: · Add BrowserStack notice into readme ([#3178](https://github.com/hanzoai/team-manager/issues/3178)) 
* UBER-87: · Add new icons ([#3188](https://github.com/hanzoai/team-manager/issues/3188)) 
* USER-145: · Fixed FixedColumn ([#3216](https://github.com/hanzoai/team-manager/issues/3216)) 
* USER-79: · Fixed the sidebar in the Panel. Update IssuePreview layout. ([#3201](https://github.com/hanzoai/team-manager/issues/3201)) 

## [0.6.95] - 2023-05-12

* TSK-1324: · Update popups and colors ([#3152](https://github.com/hanzoai/team-manager/issues/3152)) 
* TSK-1387: · Count cancelled sub-issues as completed ([#3158](https://github.com/hanzoai/team-manager/issues/3158)) 
* TSK-1418: · Make issue notification width smaller ([#3160](https://github.com/hanzoai/team-manager/issues/3160)) 
* TSK-1429: · Rework dueDate to ignore overdue in applicants, kanban and right panel ([#3169](https://github.com/hanzoai/team-manager/issues/3169)) 
* TSK-1432: · Fix popup closing ([#3170](https://github.com/hanzoai/team-manager/issues/3170)) 
* TSK-1436: · Change deleting spaces to removing, add action to move all non-valid requests to correct spaces ([#3149](https://github.com/hanzoai/team-manager/issues/3149)) 
* TSK-1451: · Fix focus issues + jump workaround ([#3167](https://github.com/hanzoai/team-manager/issues/3167)) 
* TSK-1452: · Revert sprint statistics display ([#3142](https://github.com/hanzoai/team-manager/issues/3142)) 
* TSK-1454: · Added varieties to the TabList ([#3161](https://github.com/hanzoai/team-manager/issues/3161)) 
* TSK-1459: · Update Panel layout ([#3163](https://github.com/hanzoai/team-manager/issues/3163)) 
* TSK-742: · Use partial binary protocol with ability on/off ([#3153](https://github.com/hanzoai/team-manager/issues/3153)) 

## [0.6.94] - 2023-05-04

* TSK-1098: · My issues list ([#3137](https://github.com/hanzoai/team-manager/issues/3137)) 
* TSK-1236: · Trigger to remove members when deleting department. Fix for already broken departments ([#3120](https://github.com/hanzoai/team-manager/issues/3120)) 
* TSK-1257: · Add sorting by create time ([#3138](https://github.com/hanzoai/team-manager/issues/3138)) 
* TSK-1409: · Bump. client resources 0.6.16 ([#3134](https://github.com/hanzoai/team-manager/issues/3134)) 
* TSK-831: · Edit issue fixes ([#3140](https://github.com/hanzoai/team-manager/issues/3140)) 
...
* TSK-1166: · Sprint editor action ([#3110](https://github.com/hanzoai/team-manager/issues/3110)) 
* TSK-1206: · Drag-drop statuses between categories ([#3112](https://github.com/hanzoai/team-manager/issues/3112)) 
* TSK-1324: · Update kanban layout ([#3118](https://github.com/hanzoai/team-manager/issues/3118)) 
* TSK-1339: · Resize tooltip for dueDate and ignore overdue in done/cancelled ([#3113](https://github.com/hanzoai/team-manager/issues/3113)) 
* TSK-1393: · Fix status findAll requests extra data ([#3105](https://github.com/hanzoai/team-manager/issues/3105)) 
* TSK-1405: · Fix hover selection ([#3109](https://github.com/hanzoai/team-manager/issues/3109)) 
* TSK-1406: · Correct Configuration defaults ([#3107](https://github.com/hanzoai/team-manager/issues/3107)) 
* TSK-1410,-1408,-1392,-1389,-1386,-1377: · Minor fixes. Update IssueNotification layout. ([#3117](https://github.com/hanzoai/team-manager/issues/3117)) 

## [0.6.91a] - 2023-04-27

* TSK-1339: · Show dueDate for cancelled/done issues ([#3091](https://github.com/hanzoai/team-manager/issues/3091)) 
* TSK-1378: · Qfix for exception ([#3097](https://github.com/hanzoai/team-manager/issues/3097)) 
* TSK-1381: · Show preview and Table mouse hover selection ([#3098](https://github.com/hanzoai/team-manager/issues/3098)) 

## [0.6.91] - 2023-04-27

* TSK-1009: · Configurable platform ([#3055](https://github.com/hanzoai/team-manager/issues/3055)) 
* TSK-1066: · Don't allow creating requests if already exists for set days ([#3053](https://github.com/hanzoai/team-manager/issues/3053)) 
* TSK-1068: · Update department for Staff via side panel ([#3073](https://github.com/hanzoai/team-manager/issues/3073)) 
* TSK-1098: · All issues related fixes ([#3079](https://github.com/hanzoai/team-manager/issues/3079)) 
* TSK-1113: · Add issueUrl to notification for sub-issues ([#3057](https://github.com/hanzoai/team-manager/issues/3057)) 
* TSK-1114: · Fix default issue status ([#3044](https://github.com/hanzoai/team-manager/issues/3044)) 
* TSK-1248: · Revert changes and add check for unset field ([#3054](https://github.com/hanzoai/team-manager/issues/3054)) 
* TSK-1311: · Add editors for String and Number ([#3056](https://github.com/hanzoai/team-manager/issues/3056)) 
* TSK-1312: · Refit tooltip after loading components inside it ([#3083](https://github.com/hanzoai/team-manager/issues/3083)) 
* TSK-1314: · Fix slow Kanban open ([#3052](https://github.com/hanzoai/team-manager/issues/3052)) 
* TSK-1323: · Fix colors for list ([#3069](https://github.com/hanzoai/team-manager/issues/3069)) 
* TSK-1342: · Reduce number of transfer data and improve Kanban initial render speed ([#3078](https://github.com/hanzoai/team-manager/issues/3078)) 
* TSK-1353: · Update ListView headers. Replaced colors in settings. ([#3086](https://github.com/hanzoai/team-manager/issues/3086)) 
* TSK-1375: · Sub issue selector icons ([#3089](https://github.com/hanzoai/team-manager/issues/3089)) 
* TSK-571: · Fix keyboard list navigation ([#3085](https://github.com/hanzoai/team-manager/issues/3085)) 

## [0.6.90] - 2023-04-23

* TSK-1243: · Add scroller to project's components list ([#3045](https://github.com/hanzoai/team-manager/issues/3045)) 

## [0.6.89] - 2023-04-21

* TSK-1047: · Fix showing requests after moving staff to another department ([#3029](https://github.com/hanzoai/team-manager/issues/3029)) 
* TSK-1064: · Fix export csv in hr ([#3032](https://github.com/hanzoai/team-manager/issues/3032)) 
* TSK-1237: · Improve full text indexer ([#3025](https://github.com/hanzoai/team-manager/issues/3025)) 
* TSK-1274: · Fix Kanban live updates ([#3024](https://github.com/hanzoai/team-manager/issues/3024)) 

## [0.6.88] - 2023-04-19

* TSK-1248: · Sort null last for dates ([#3021](https://github.com/hanzoai/team-manager/issues/3021)) 
* TSK-1252: · Dispatch update event for attribute bar ([#3017](https://github.com/hanzoai/team-manager/issues/3017)) 
* TSK-964: · Fit popup when component is loaded. Redo cases when popup doesn't fit due to small window sizes ([#3022](https://github.com/hanzoai/team-manager/issues/3022)) 

## [0.6.87] - 2023-04-19

* TSK-1158: · Remove component from sprint. Remove logic for changing component on sprint change ([#2998](https://github.com/hanzoai/team-manager/issues/2998)) 
* TSK-1248: · Fix dueDate sorting order ([#3013](https://github.com/hanzoai/team-manager/issues/3013)) 
* TSK-808: · Ignore initial validation when autofilled for login form ([#3012](https://github.com/hanzoai/team-manager/issues/3012)) 

## [0.6.86] - 2023-04-17

* TSK-1213: · Allow to clean archived vacancies with content ([#2999](https://github.com/hanzoai/team-manager/issues/2999)) 
* TSK-1216: · Fix bitrix import ([#3005](https://github.com/hanzoai/team-manager/issues/3005)) 
* TSK-753: · Open user's department in schedule by default ([#3001](https://github.com/hanzoai/team-manager/issues/3001)) 

## [0.6.85] - 2023-04-17

* TSK-1032: · Add confirmation dialog for projects, fix sprint deleting and allow deleting for Owner or creator only ([#2964](https://github.com/hanzoai/team-manager/issues/2964)) 
* TSK-1201: · Fix bitrix migration and too to clean removed transactions ([#2995](https://github.com/hanzoai/team-manager/issues/2995)) 

## [0.6.84] - 2023-04-16

* TSK-1200: · Fix Applications with wrong state ([#2992](https://github.com/hanzoai/team-manager/issues/2992)) 

## [0.6.83] - 2023-04-14

* TSK-1062: · Work on Employee and EmployeeAccount migration ([#2986](https://github.com/hanzoai/team-manager/issues/2986)) 
* TSK-1189: · Fix showing all available categories ([#2987](https://github.com/hanzoai/team-manager/issues/2987)) 
* TSK-1194: · Fix filter ([#2990](https://github.com/hanzoai/team-manager/issues/2990)) 

## [0.6.82] - 2023-04-13

* TSK-1152: · Fix connections mess ([#2969](https://github.com/hanzoai/team-manager/issues/2969)) 
* TSK-1153: · Fix server model load exceptions ([#2967](https://github.com/hanzoai/team-manager/issues/2967)) 
* TSK-1154: · Statuses table support ([#2974](https://github.com/hanzoai/team-manager/issues/2974)) 
* TSK-1170: · Fix transactions retrieval to speedup of workspace open ([#2976](https://github.com/hanzoai/team-manager/issues/2976)) 

## [0.6.81] - 2023-04-12

* TSK-1012: · Change text names for Organizations to Companies ([#2963](https://github.com/hanzoai/team-manager/issues/2963)) 
* TSK-1086: · Fix merge ([#2961](https://github.com/hanzoai/team-manager/issues/2961)) 
* TSK-1141: · Fix bitrix fields ([#2956](https://github.com/hanzoai/team-manager/issues/2956)) 
* TSK-1146: · Support initial content text for collaborator doc ([#2960](https://github.com/hanzoai/team-manager/issues/2960)) 
* TSK-1148: · Mixin button for Vacancy and NPE fixes ([#2965](https://github.com/hanzoai/team-manager/issues/2965)) 
* TSK-1150: · Rollback svelte ([#2966](https://github.com/hanzoai/team-manager/issues/2966)) 
...
* TSK-1040: · Support editable for DraggableList ([#2932](https://github.com/hanzoai/team-manager/issues/2932)) 
* TSK-1072: · Fix Created by ([#2948](https://github.com/hanzoai/team-manager/issues/2948)) 
* TSK-1092: · Fix reconnect for Safari ([#2929](https://github.com/hanzoai/team-manager/issues/2929)) 
* TSK-1093: · Fix Application doneState showing ([#2927](https://github.com/hanzoai/team-manager/issues/2927)) 
* TSK-1106: · Update to latest packages ([#2943](https://github.com/hanzoai/team-manager/issues/2943)) 

## [0.6.79] - 2023-04-07

* TSK-1007: · Add comments in talent editor ([#2922](https://github.com/hanzoai/team-manager/issues/2922)) 
* TSK-1013: · Add position field to Employee ([#2874](https://github.com/hanzoai/team-manager/issues/2874)) 
* TSK-1015: · Bitrix Create Vacancy/Application ([#2913](https://github.com/hanzoai/team-manager/issues/2913)) 
* TSK-1038: · Fix comments presenter ([#2896](https://github.com/hanzoai/team-manager/issues/2896)) 
* TSK-1062: · Fix merge properly ([#2919](https://github.com/hanzoai/team-manager/issues/2919)) 
* TSK-1065: · Check model version ([#2916](https://github.com/hanzoai/team-manager/issues/2916)) 
* TSK-1088: · Show Kanban counters ([#2924](https://github.com/hanzoai/team-manager/issues/2924)) 
* TSK-943: · General Status support ([#2842](https://github.com/hanzoai/team-manager/issues/2842)) 
* TSK-990: · Remove Back button in settings ([#2875](https://github.com/hanzoai/team-manager/issues/2875)) 
* TSK-1040: · Support draft for DraggableList ([#2898](https://github.com/hanzoai/team-manager/issues/2898)) 

## [0.6.78] - 2023-04-03

* TSK-1010: · Change color for New Customer button ([#2870](https://github.com/hanzoai/team-manager/issues/2870)) 
* TSK-950: · Remove value from filter if the object doesn't exist ([#2852](https://github.com/hanzoai/team-manager/issues/2852)) 

## [0.6.77] - 2023-03-31

* TSK-839: · Fix localization strings ([#2833](https://github.com/hanzoai/team-manager/issues/2833)) 
* TSK-903: · Do not allow saving if set to private with no members ([#2854](https://github.com/hanzoai/team-manager/issues/2854)) 
* TSK-916: · Fix attribute errors in console ([#2839](https://github.com/hanzoai/team-manager/issues/2839)) 
* TSK-942: · Add hours to current time ([#2837](https://github.com/hanzoai/team-manager/issues/2837)) 
* TSK-955: · Fix status display ([#2840](https://github.com/hanzoai/team-manager/issues/2840)) 
* TSK-960: · Move for issues ([#2846](https://github.com/hanzoai/team-manager/issues/2846)) 
* TSK-963: · Show avatar on comments ([#2857](https://github.com/hanzoai/team-manager/issues/2857)) 
* TSK-976: · Hide preview action ([#2847](https://github.com/hanzoai/team-manager/issues/2847)) 
* TSK-983: · Fix Cache control for index pages ([#2850](https://github.com/hanzoai/team-manager/issues/2850)) 
* TSK-987: · Show filter with 0 value ([#2855](https://github.com/hanzoai/team-manager/issues/2855)) 
* TSK-988: · Sticky first column in hr calendar ([#2867](https://github.com/hanzoai/team-manager/issues/2867)) 
* TSK-989: · Transparent requests (PTO, extra, etc.) when not in department or it's descendants ([#2861](https://github.com/hanzoai/team-manager/issues/2861)) 
* TSK-992: · Fix column name in Companies ([#2860](https://github.com/hanzoai/team-manager/issues/2860)) 

## [0.6.76a] - 2023-03-24

* TSK-897: · Allow team-leads and managers to edit descendant departments ([#2825](https://github.com/hanzoai/team-manager/issues/2825)) 
* TSK-941: · Fix incorrect rewriting space after selecting in SpaceSelect ([#2827](https://github.com/hanzoai/team-manager/issues/2827)) 

## [0.6.76] - 2023-03-24

* TSK-745: · Do not allow changing previous months events (Requests and public holidays) ([#2796](https://github.com/hanzoai/team-manager/issues/2796)) 
* TSK-811: · Fix for undefined when saving platform last location ([#2790](https://github.com/hanzoai/team-manager/issues/2790)) 
* TSK-813: · Fix input width and remove divider for time report popup ([#2794](https://github.com/hanzoai/team-manager/issues/2794)) 
* TSK-825: · Client proper reconnection ([#2797](https://github.com/hanzoai/team-manager/issues/2797)) 
* TSK-831: · Edit Title and Description inline ([#2788](https://github.com/hanzoai/team-manager/issues/2788)) 
* TSK-858: · Send picture without text as comment for issues ([#2793](https://github.com/hanzoai/team-manager/issues/2793)) 
* TSK-885: · Fix invalid deps ([#2777](https://github.com/hanzoai/team-manager/issues/2777)) 
* TSK-912: · Notifications on removing the request ([#2806](https://github.com/hanzoai/team-manager/issues/2806)) 
* TSK-915: · Tracker status ([#2802](https://github.com/hanzoai/team-manager/issues/2802)) 
* TSK-920: · Rename CreatedBy field ([#2807](https://github.com/hanzoai/team-manager/issues/2807)) 
* TSK-924: · Follow proper order for Tracker Kanban ([#2815](https://github.com/hanzoai/team-manager/issues/2815)) 
* TSK-934: · Redirect to last location on opening main page ([#2817](https://github.com/hanzoai/team-manager/issues/2817)) 
* TSK-937: · Fix tooltip for employee ([#2822](https://github.com/hanzoai/team-manager/issues/2822)) 

## [0.6.75b] - 2023-03-21

* TSK-894: · Fix template creation and apply ([#2785](https://github.com/hanzoai/team-manager/issues/2785)) 
* TSK-895: · Allow to mention only active employees ([#2786](https://github.com/hanzoai/team-manager/issues/2786)) 
...
* TSK-811: · Show last workspace location after switching/opening workspace ([#2776](https://github.com/hanzoai/team-manager/issues/2776)) 
* TSK-813: · Remove WorkDayLength and change time reports to hours ([#2763](https://github.com/hanzoai/team-manager/issues/2763)) 
* TSK-859: · Replacing icons. TSK-883: Pop-up for viewing images. ([#2782](https://github.com/hanzoai/team-manager/issues/2782)) 
* TSK-871: · Fix overtime display ([#2769](https://github.com/hanzoai/team-manager/issues/2769)) 
* TSK-879: · Fix empty assignee selection ([#2774](https://github.com/hanzoai/team-manager/issues/2774)) 
* TSK-890: · Fix component icons ([#2778](https://github.com/hanzoai/team-manager/issues/2778)) 
* TSK-891: · Fix UI Tests instability ([#2780](https://github.com/hanzoai/team-manager/issues/2780)) 

## [0.6.74] - 2023-03-17

* TSK-812: · Opening images in the center. Minor design corrections. ([#2755](https://github.com/hanzoai/team-manager/issues/2755)) 
* TSK-857: · Create company button ([#2762](https://github.com/hanzoai/team-manager/issues/2762)) 

## [0.6.73a] - 2023-03-16

* TSK-568: · User-friendly message on join for expired links ([#2752](https://github.com/hanzoai/team-manager/issues/2752)) 
* TSK-802: · Save token to array ([#2754](https://github.com/hanzoai/team-manager/issues/2754)) 
* TSK-807: · Query only active Employees ([#2753](https://github.com/hanzoai/team-manager/issues/2753)) 
* TSK-849: · Show labels in list ([#2749](https://github.com/hanzoai/team-manager/issues/2749)) 

## [0.6.73] - 2023-03-16

* TSK-791: · Handle department's public holidays + add stats for it ([#2735](https://github.com/hanzoai/team-manager/issues/2735)) 
* TSK-827: · Rename Process to Pattern ([#2740](https://github.com/hanzoai/team-manager/issues/2740)) 
* TSK-837: · Fix backup OOM ([#2732](https://github.com/hanzoai/team-manager/issues/2732)) 
* TSK-838: · Created by ([#2742](https://github.com/hanzoai/team-manager/issues/2742)) 
* TSK-842: · Fix resume recognition functionality ([#2736](https://github.com/hanzoai/team-manager/issues/2736)) 
* TSL-840: · Fixed the display of Filtered views ([#2743](https://github.com/hanzoai/team-manager/issues/2743)) 

## [0.6.72a] - 2023-03-13

* TSK-803: · Fix load speed ([#2728](https://github.com/hanzoai/team-manager/issues/2728)) 

## [0.6.69b] - 2023-03-02

* TSK-761: · Team default assignee ([#2706](https://github.com/hanzoai/team-manager/issues/2706)) 
* TSK-769: · Fix channel editor ([#2704](https://github.com/hanzoai/team-manager/issues/2704)) 

## [0.6.69] - 2023-03-01

* TSK-517: · Show 'Last Modified' instead of 'Date' for attachments ([#2696](https://github.com/hanzoai/team-manager/issues/2696)) 
* TSK-713: · Notifications for DM ([#2695](https://github.com/hanzoai/team-manager/issues/2695)) 
* TSK-728: · Server reconnect support ([#2689](https://github.com/hanzoai/team-manager/issues/2689)) 
* TSK-734: · Fix Bitrix email import ([#2700](https://github.com/hanzoai/team-manager/issues/2700)) 

## [0.6.68] - 2023-02-22

* EZQ-49: · Update collaborator ([#2677](https://github.com/hanzoai/team-manager/issues/2677)) 
* TSK-544: · Search by issue number and description ([#2675](https://github.com/hanzoai/team-manager/issues/2675)) 

## [0.6.67] - 2023-02-20

* TSK-467: · Throw error when used for AttachedDoc ([#2649](https://github.com/hanzoai/team-manager/issues/2649)) 
* TSK-637: · Add login and recovery action ([#2654](https://github.com/hanzoai/team-manager/issues/2654)) 
* TSK-678: · Update First/Last names ([#2652](https://github.com/hanzoai/team-manager/issues/2652)) 
* TSK-679: · Add Whatsapp ([#2651](https://github.com/hanzoai/team-manager/issues/2651)) 
* TSK-685: · Prioritise selection when focus exists ([#2648](https://github.com/hanzoai/team-manager/issues/2648)) 

## [0.6.65] - 2023-02-10

* TSK-651: · Fix Team editing ([#2611](https://github.com/hanzoai/team-manager/issues/2611)) 

## [0.6.64] - 2023-02-08

* TSK-413: · Implement scrum recording ([#2550](https://github.com/hanzoai/team-manager/issues/2550)) 
* TSK-570: · Fix RelatedIssues ([#2596](https://github.com/hanzoai/team-manager/issues/2596)) 
* TSK-608: · Move Vacancy support. ([#2597](https://github.com/hanzoai/team-manager/issues/2597)) 

## [0.6.61] - 2023-01-30

* TSK-476: · Bitrix import fixes ([#2548](https://github.com/hanzoai/team-manager/issues/2548)) 
* TSK-569: · Fix MarkupPresenter, ShowMore ([#2553](https://github.com/hanzoai/team-manager/issues/2553)) 

## [0.6.57] - 2023-01-24

* TSK-553: · Fix padding in assignee popup ([#2531](https://github.com/hanzoai/team-manager/issues/2531)) 

## [0.6.55] - 2023-01-20

* TSK-360: · Assignee selection enhancements ([#2509](https://github.com/hanzoai/team-manager/issues/2509)) 

## [0.6.53a] - 2022-12-30

* TSK-507: · Assignee box Direction line is hidden to early ([#2485](https://github.com/hanzoai/team-manager/issues/2485)) 

## [0.6.52] - 2022-12-22

* TSK-485: · Calendar Year/Month summary ([#2465](https://github.com/hanzoai/team-manager/issues/2465)) 

## [0.6.51] - 2022-12-21

* TSK-473: · Added tracker layout sanity tests ([#2452](https://github.com/hanzoai/team-manager/issues/2452)) 

## [0.6.50] - 2022-12-16

* TSK-487: · Resume draft stuck in Resume state ([#2443](https://github.com/hanzoai/team-manager/issues/2443)) 

## [0.6.49] - 2022-12-15

* TSK-344: · Draft for new Candidate/Person etc ([#2432](https://github.com/hanzoai/team-manager/issues/2432)) 
* TSK-425: · Supported team settings ([#2406](https://github.com/hanzoai/team-manager/issues/2406)) 
* TSK-461: · Refactor Tracker/Remember Issues ([#2425](https://github.com/hanzoai/team-manager/issues/2425)) 

## [0.6.48] - 2022-12-07

* TSK-343: · Remember unfinished comment per document ([#2400](https://github.com/hanzoai/team-manager/issues/2400)) 
* TSK-458: · Create of sub-issue not show Issue created notification ([#2419](https://github.com/hanzoai/team-manager/issues/2419)) 

## [0.6.47] - 2022-12-02

* TSK-419: · Update workspaces while open menu ([#2413](https://github.com/hanzoai/team-manager/issues/2413)) 

## [0.6.46] - 2022-11-29

* ACTIVITY: · Filters ([#2395](https://github.com/hanzoai/team-manager/issues/2395)) 
...
* HR: · Update Schedule layout. Fix tooltip and popup. ([#2388](https://github.com/hanzoai/team-manager/issues/2388)) 
* TSK-399: · Allow to delete sprints ([#2386](https://github.com/hanzoai/team-manager/issues/2386)) 
* TSK-420: · Fixed time report placeholders ([#2390](https://github.com/hanzoai/team-manager/issues/2390)) 

## [0.6.41] - 2022-11-12

* TSK-363: · Fixed multiple no sprint category ([#2352](https://github.com/hanzoai/team-manager/issues/2352)) 
* TSK-364: · Fixed filter updates for collapse issues state ([#2355](https://github.com/hanzoai/team-manager/issues/2355)) 

## [0.6.40] - 2022-11-02

* TSK-212: · Add notification on issue created ([#2325](https://github.com/hanzoai/team-manager/issues/2325)) 
* TSK-342: · Add resume issue function ([#2332](https://github.com/hanzoai/team-manager/issues/2332)) 

## [0.6.34] - 2022-08-25

* TRACKER: · Enlarged headers ([#2259](https://github.com/hanzoai/team-manager/issues/2259)) 
...
* TSK-268: · Supported expandable for issue list ([#2222](https://github.com/hanzoai/team-manager/issues/2222)) 
...
* BOARD: · Fix show popup actions ([#2211](https://github.com/hanzoai/team-manager/issues/2211)) 
* TRACKER: · Fix colors for issue status icons ([#2203](https://github.com/hanzoai/team-manager/issues/2203)) · Fix kanban query ([#2204](https://github.com/hanzoai/team-manager/issues/2204)) · Updated status icons ([#2215](https://github.com/hanzoai/team-manager/issues/2215)) · Labels on the card. ([#2221](https://github.com/hanzoai/team-manager/issues/2221)) · Hide inbox / views ([#2224](https://github.com/hanzoai/team-manager/issues/2224)) 

## [0.6.30a] - 2022-07-04

* HR: · Update schedule layout ([#2202](https://github.com/hanzoai/team-manager/issues/2202)) 
* USERBOX: · Clean up selected for user box on value change ([#2199](https://github.com/hanzoai/team-manager/issues/2199)) 

## [0.6.30] - 2022-07-02

* AUTOMATION: · Disable UI ([#2158](https://github.com/hanzoai/team-manager/issues/2158)) 
* BOARD: · Remove server plugin ([#2159](https://github.com/hanzoai/team-manager/issues/2159)) 
* EDITBOX: · Fixed size calculation ([#2181](https://github.com/hanzoai/team-manager/issues/2181)) 
* HR: · Update values on blur ([#2161](https://github.com/hanzoai/team-manager/issues/2161)) 
* TRACKER: · Fix extra refresh ([#2160](https://github.com/hanzoai/team-manager/issues/2160)) · Add relation ([#2174](https://github.com/hanzoai/team-manager/issues/2174)) · Workflow statuses ([#2171](https://github.com/hanzoai/team-manager/issues/2171)) · Add issues up/down navigator ([#2188](https://github.com/hanzoai/team-manager/issues/2188)) 

## [0.6.29b] - 2022-06-27

* CHUNTER: · Open message links without reload ([#2124](https://github.com/hanzoai/team-manager/issues/2124)) 

## [0.6.29a] - 2022-06-27

* TRACKER: · Parent issues name ([#2136](https://github.com/hanzoai/team-manager/issues/2136)) · Sync project with parent ([#2137](https://github.com/hanzoai/team-manager/issues/2137)) 

## [0.6.29] - 2022-06-25

* ACTIVITY: · Fix comments display ([#2143](https://github.com/hanzoai/team-manager/issues/2143)) 
* AUTOMATION: · Initial support ([#2134](https://github.com/hanzoai/team-manager/issues/2134)) 
* TRACKER: · Issues search ([#2129](https://github.com/hanzoai/team-manager/issues/2129)) · Introduce Roadmap ([#2139](https://github.com/hanzoai/team-manager/issues/2139)) 
* UI: · Refactor ([#2127](https://github.com/hanzoai/team-manager/issues/2127)) 

## [0.6.28] - 2022-06-20

* BOARD: · Fix header ([#2098](https://github.com/hanzoai/team-manager/issues/2098)) 
* CHUNTER: · Copy link to message ([#2078](https://github.com/hanzoai/team-manager/issues/2078)) 
* TRACKER: · Fix status editor ([#2097](https://github.com/hanzoai/team-manager/issues/2097)) 

## [0.6.27] - 2022-06-15

* CHUNTER: · Add button for link formatting ([#2063](https://github.com/hanzoai/team-manager/issues/2063)) 
* TSK-112: · Fix workbench switch ([#2074](https://github.com/hanzoai/team-manager/issues/2074)) 
* TSK-81: · Disable State delete action ([#2076](https://github.com/hanzoai/team-manager/issues/2076)) 
* TAGS: · Fix collection editor ([#2080](https://github.com/hanzoai/team-manager/issues/2080)) · Add inline editor ([#2081](https://github.com/hanzoai/team-manager/issues/2081)) 
* TRACKER: · Add priority to sub-issues ([#2054](https://github.com/hanzoai/team-manager/issues/2054)) 

## [0.6.26] - 2022-06-10

* BOARD: · Fix tags/labels for board table view ([#2045](https://github.com/hanzoai/team-manager/issues/2045)) · Fix attribute views for tags ([#2046](https://github.com/hanzoai/team-manager/issues/2046)) · Update popups style ([#2043](https://github.com/hanzoai/team-manager/issues/2043)) · Add labels view ([#2047](https://github.com/hanzoai/team-manager/issues/2047)) 

## [0.6.25] - 2022-06-08

* TRACKER: · Added Projects to the card ([#2023](https://github.com/hanzoai/team-manager/issues/2023)) · Updating cards in Kanban ([#2032](https://github.com/hanzoai/team-manager/issues/2032)) · Add "Show Sub-issues" toggle into issue list ([#2033](https://github.com/hanzoai/team-manager/issues/2033)) 

## [0.6.24] - 2022-06-07

* PANEL: · Remove full size. Fix popup. ([#2007](https://github.com/hanzoai/team-manager/issues/2007)) 
* TRACKER: · Add project issue list view ([#2012](https://github.com/hanzoai/team-manager/issues/2012)) 

## [0.6.23] - 2022-06-03

* BOARD: · Update server-plugin for task to subscribe to updates on create & update ([#1925](https://github.com/hanzoai/team-manager/issues/1925)) 
* FLITERBAR: · Remove save button ([#1937](https://github.com/hanzoai/team-manager/issues/1937)) 
* SCROLLER: · Added autohide. Fixed track height when displaying table and colors. ([#1964](https://github.com/hanzoai/team-manager/issues/1964)) 
* TRACKER: · Change "Issue" type to "AttachedDoc" ([#1875](https://github.com/hanzoai/team-manager/issues/1875)) · Add Sub-issues list ([#1989](https://github.com/hanzoai/team-manager/issues/1989)) · Fix console errors in the Issue Editor ([#2001](https://github.com/hanzoai/team-manager/issues/2001)) 

## [0.6.22] - 2022-05-29

* BOARD: · Update actions ([#1859](https://github.com/hanzoai/team-manager/issues/1859)) · Fix cover presenter ([#1872](https://github.com/hanzoai/team-manager/issues/1872)) · Checklist item dnd support ([#1873](https://github.com/hanzoai/team-manager/issues/1873)) 
* HR: · Issue fixes ([#1891](https://github.com/hanzoai/team-manager/issues/1891)) 
* TRACKER: · Add "Parent Issue" control to the "Edit Issue" dialog ([#1857](https://github.com/hanzoai/team-manager/issues/1857)) 

## [0.6.21] - 2022-05-24

* CONTACTS: · Type Filter ([#1855](https://github.com/hanzoai/team-manager/issues/1855)) 

## [0.6.20] - 2022-05-23

* BOARD: · Update card ([#1826](https://github.com/hanzoai/team-manager/issues/1826)) 

## [0.6.19] - 2022-05-22

* BOARD: · Add TableView ([#1760](https://github.com/hanzoai/team-manager/issues/1760)) · Use Standard actions ([#1766](https://github.com/hanzoai/team-manager/issues/1766)) · Add checklists info ([#1772](https://github.com/hanzoai/team-manager/issues/1772)) · Add checklist assignee ([#1778](https://github.com/hanzoai/team-manager/issues/1778)) · Add convert checklist to card action ([#1805](https://github.com/hanzoai/team-manager/issues/1805)) 
* CHUNTER: · Convert direct message to private channel ([#1752](https://github.com/hanzoai/team-manager/issues/1752)) · Open dm on creation if already exists ([#1773](https://github.com/hanzoai/team-manager/issues/1773)) · Formatting ([#1804](https://github.com/hanzoai/team-manager/issues/1804)) 
* EDITISSUE: · Fix "Due date" button style. ([#1824](https://github.com/hanzoai/team-manager/issues/1824)) 
* HR: · Fixes to Vacancy/Application creation ([#1753](https://github.com/hanzoai/team-manager/issues/1753)) 
* TELEGRAM: · Latest messages below. Update AttachmentPreview layout. ([#1768](https://github.com/hanzoai/team-manager/issues/1768)) 
* TRACKER: · Project - Project selector ([#1740](https://github.com/hanzoai/team-manager/issues/1740)) · Split "edit issue" dialog to preview / edit ([#1731](https://github.com/hanzoai/team-manager/issues/1731)) · Project - Editors ([#1779](https://github.com/hanzoai/team-manager/issues/1779)) · Project - Project status buttons ([#1793](https://github.com/hanzoai/team-manager/issues/1793)) · Add context menu to the "EditIssue" dialog ([#1788](https://github.com/hanzoai/team-manager/issues/1788)) · "Edit Issue" dialog adjustments ([#1810](https://github.com/hanzoai/team-manager/issues/1810)) 

## [0.6.18] - 2022-05-15

* BOARD: · Initial checklist support ([#1672](https://github.com/hanzoai/team-manager/issues/1672)) · Refactor AddPanel with TextAreaEditor ([#1720](https://github.com/hanzoai/team-manager/issues/1720)) · Fix copy from message · Fix push/pull activity ([#1718](https://github.com/hanzoai/team-manager/issues/1718)) 
* CHUNTER: · User status ([#1608](https://github.com/hanzoai/team-manager/issues/1608)) ([#1692](https://github.com/hanzoai/team-manager/issues/1692)) 
* TRACKER: · Issue filters - additional features ([#1708](https://github.com/hanzoai/team-manager/issues/1708)) 

## [0.6.15] - 2022-05-05

* BOARD: · Remove stale left panel items ([#1574](https://github.com/hanzoai/team-manager/issues/1574)) · Fix card members update ([#1620](https://github.com/hanzoai/team-manager/issues/1620)) · Checklists model adjustments ([#1633](https://github.com/hanzoai/team-manager/issues/1633)) 
* CHUNTER: · File browser additional fixes ([#1547](https://github.com/hanzoai/team-manager/issues/1547)) · Download file action ([#1570](https://github.com/hanzoai/team-manager/issues/1570)) · FileBrowser - add grid view ([#1571](https://github.com/hanzoai/team-manager/issues/1571)) · FileBrowser - replace px with rem ([#1582](https://github.com/hanzoai/team-manager/issues/1582)) · Remove attachments only for creator ([#1552](https://github.com/hanzoai/team-manager/issues/1552)) · Private channel & add channel members ui ([#1524](https://github.com/hanzoai/team-manager/issues/1524)) ([#1589](https://github.com/hanzoai/team-manager/issues/1589)) 
* EDITISSUE: · Add due date to the right panel ([#1272](https://github.com/hanzoai/team-manager/issues/1272)) ([#1642](https://github.com/hanzoai/team-manager/issues/1642)) 
* TRACKER: · Fix IssuesList selection ([#1578](https://github.com/hanzoai/team-manager/issues/1578)) · Rewrite AssigneePresenter ([#1568](https://github.com/hanzoai/team-manager/issues/1568)) · Fix issue status view for "Activity" ([#1632](https://github.com/hanzoai/team-manager/issues/1632)) · Fix issue priority view for "Activity" ([#1635](https://github.com/hanzoai/team-manager/issues/1635)) · Issue filters - main functionality ([#1640](https://github.com/hanzoai/team-manager/issues/1640)) 

## [0.6.14] - 2022-04-26

* BOARD: · Add open card inline menu ([#1511](https://github.com/hanzoai/team-manager/issues/1511)) · Handle labels when move card to another board ([#1538](https://github.com/hanzoai/team-manager/issues/1538)) · Make context menu consistent ([#1542](https://github.com/hanzoai/team-manager/issues/1542)) 
* CHUNTER: · Avatars in dm header and highlight on first message ([#1499](https://github.com/hanzoai/team-manager/issues/1499)) · Saved attachments ([#1515](https://github.com/hanzoai/team-manager/issues/1515)) 
* TRACKER: · Add keyboard support for issues list ([#1539](https://github.com/hanzoai/team-manager/issues/1539)) 

## [0.6.13] - 2022-04-24

* BOARD: · Add create / edit card label popup · Fix lint issues · Update Date Presenter to reuse as presenter · Fix formatting · Use  /  for card labels update · Use  for join action · Add labels & members & date to Kanban Card ([#1462](https://github.com/hanzoai/team-manager/issues/1462)) · Fix popup alignments ([#1467](https://github.com/hanzoai/team-manager/issues/1467)) · Add attachment action ([#1474](https://github.com/hanzoai/team-manager/issues/1474)) · Extend popup positioning for Kanban card ([#1483](https://github.com/hanzoai/team-manager/issues/1483)) · Add kanban card edit mode ([#1484](https://github.com/hanzoai/team-manager/issues/1484)) 
* CHUNTER: · Saved messages ([#1466](https://github.com/hanzoai/team-manager/issues/1466)) · Direct messages ([#1472](https://github.com/hanzoai/team-manager/issues/1472)) · File browser ([#1407](https://github.com/hanzoai/team-manager/issues/1407)) ([#1488](https://github.com/hanzoai/team-manager/issues/1488)) 
* TRACKER: · View options - Grouping ([#1442](https://github.com/hanzoai/team-manager/issues/1442)) · Status should be positioned at same offset ([#1464](https://github.com/hanzoai/team-manager/issues/1464)) · View options - Completed issues period, empty groups display ([#1490](https://github.com/hanzoai/team-manager/issues/1490)) · Move "IssueStatus" enum into model ([#1449](https://github.com/hanzoai/team-manager/issues/1449)) 

## [0.6.12] - 2022-04-18

* BOARD: · Create board labels ([#1426](https://github.com/hanzoai/team-manager/issues/1426)) · Add card labels picker popup ([#1434](https://github.com/hanzoai/team-manager/issues/1434)) 
* CHUNTER: · Archive channel ([#1416](https://github.com/hanzoai/team-manager/issues/1416)) 

## [0.6.11] - 2022-04-17

* BOARD: · Design card editor (initial) ([#1292](https://github.com/hanzoai/team-manager/issues/1292)) · 1265: Make Card Actions extensible ([#1319](https://github.com/hanzoai/team-manager/issues/1319)) · Update board card model ([#1329](https://github.com/hanzoai/team-manager/issues/1329)) · Add new card actions + Join Card Action example ([#1335](https://github.com/hanzoai/team-manager/issues/1335)) · Add card details (members, labels, date) ([#1376](https://github.com/hanzoai/team-manager/issues/1376)) · Add button shape and title props ([#1381](https://github.com/hanzoai/team-manager/issues/1381)) · Fix card live updates ([#1403](https://github.com/hanzoai/team-manager/issues/1403)) · Add attachments support · Fix labels model ([#1405](https://github.com/hanzoai/team-manager/issues/1405)) · Fix infinite loop in Activity component for space update ([#1417](https://github.com/hanzoai/team-manager/issues/1417)) 
* CHUNTER: · Channel attributes ([#1334](https://github.com/hanzoai/team-manager/issues/1334)) · Delete message ([#1336](https://github.com/hanzoai/team-manager/issues/1336)) · Update channel last message and close thread on deletion from other user ([#1389](https://github.com/hanzoai/team-manager/issues/1389)) · Pin messages ([#1396](https://github.com/hanzoai/team-manager/issues/1396)) · Attachments table in channel description ([#1402](https://github.com/hanzoai/team-manager/issues/1402)) · Attachments and format updates ([#1410](https://github.com/hanzoai/team-manager/issues/1410)) · Show "edited" label and cancel button ([#1411](https://github.com/hanzoai/team-manager/issues/1411)) 
* TRACKER: · Board view ([#1325](https://github.com/hanzoai/team-manager/issues/1325)) · Issues list view ([#1313](https://github.com/hanzoai/team-manager/issues/1313)) · Issue List – Priority presenter ([#1382](https://github.com/hanzoai/team-manager/issues/1382)) · Improve CheckBox ([#1356](https://github.com/hanzoai/team-manager/issues/1356)) · Issue List – Status presenter ([#1383](https://github.com/hanzoai/team-manager/issues/1383)) · Issue List – Assignee presenter ([#1384](https://github.com/hanzoai/team-manager/issues/1384)) · Issue List - DueDate presenter ([#1393](https://github.com/hanzoai/team-manager/issues/1393)) 

## [0.6.8] - 2022-03-19

* UPD: · DataPicker with region selection. Presenters. ([#1153](https://github.com/hanzoai/team-manager/issues/1153)) 
