...
const devProductionhanzoai = clientType === 'dev-hanzoai'
const devProductionBold = clientType === 'dev-bold'
const dev =
    (process.env.CLIENT_TYPE ?? '') === 'dev' || devServer || devProduction || devProductionhanzoai || devProductionBold || devServerWorker || devServerWorkerLocal || devServerTest
...
const devProxy = {
    '/account': {
        target: 'http://hanzoai.local:3000',
        changeOrigin: true,
        pathRewrite: { '^/account': '' },
        logLevel: 'debug'
    },
    '/files': {
        target: 'http://hanzoai.local:8087',
        changeOrigin: true,
        logLevel: 'debug'
    },
    '/api/v1': {
    ...
    '/rekoni/recognize': {
        target: 'http://hanzoai.local:4004',
        changeOrigin: true,
...
const devProxyTest = {
    '/account': {
        target: 'http://hanzoai.local:3003',
        changeOrigin: true,
        pathRewrite: { '^/account': '' },
        logLevel: 'debug'
    },
    '/files': {
        target: 'http://hanzoai.local:8083',
        changeOrigin: true,
        logLevel: 'debug'
    },
    '/api/v1': {
